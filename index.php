			...
			<div id="boxes">
				...
				<aside>
					...
					<table class="loginform" width="180" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
						<tr>
							<form name="form" id="form" method="post" action="./server/acceso.php">
								<td>
								<table cellpadding="3" cellspacing="1" bgcolor="#E2E2E2">
									...
									?>
									<tr>
										<td id="fail">Datos incorrectos</td>
									</tr>
									<?php
											}
										}
									?>
									<tr>
										<td id="noreg"><a href="./registro.php">Registrarse</a></td>
										<td>&nbsp;</td>
										<td>
